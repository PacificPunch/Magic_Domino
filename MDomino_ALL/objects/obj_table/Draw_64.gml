...
// --- ЛОГИКА И ОТРИСОВКА КНОПКИ "МЕНЮ" ---
var hover1 = (mx > btn_x - btn_w/2 && mx < btn_x + btn_w/2 && my > btn_1_y - btn_h/2 && my < btn_1_y + btn_h/2);

if (hover1) {
    gpu_set_blendmode(bm_add);
    draw_sprite_ext(spr, 0, btn_x, btn_1_y, 1.05, 1.05, 90, c_lime, 0.4);
    gpu_set_blendmode(bm_normal);
}
draw_sprite_ext(spr, 0, btn_x, btn_1_y, 1, 1, 90, c_white, 1);

draw_set_color(c_black); // Цвет текста
draw_text(btn_x, btn_1_y, "МЕНЮ");
