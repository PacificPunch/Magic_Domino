...
if (instance_exists(obj_player_hand_b_all)) {
    with (obj_player_hand_b_all) arrange_player_hand(); // или твой скрипт для расстановки
}
if (instance_exists(obj_computer_hand_b_all)) {
