...
if (!global.game_over) {
    ...
    _draw_effect(_eff_x, _eff_y, _spr, _scale, c_green, "Земля - заставляет противника взять кость");
    _draw_effect(_eff_x, _eff_y + _spacing, _spr, _scale, c_aqua, "Ветер - сбрасывает кость из руки");
    _draw_effect(_eff_x, _eff_y + _spacing * 2, _spr, _scale, c_red, "Огонь - сжигает кости в цепи");
    _draw_effect(_eff_x, _eff_y + _spacing * 3, _spr, _scale, c_blue, "Вода - дает доп ход");
    _draw_effect(_eff_x, _eff_y + _spacing * 4, _spr, _scale, c_yellow, "Лотос - стихийный джокер");
