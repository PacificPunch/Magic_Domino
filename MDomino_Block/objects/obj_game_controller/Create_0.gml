...
// --- БЛОК ОЧИСТКИ (ВСТАВЛЯТЬ СЮДА) ---
// 1. Проверяем наличие глобальных переменных и уничтожаем старые списки
...
// 2. Удаляем все существующие объекты домино, если они остались в комнате
